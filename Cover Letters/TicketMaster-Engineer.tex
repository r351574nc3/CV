...
\homepage{http://goo.gl/N3s9mS}                         % optional, remove / comment the line if not wanted
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Ticketmaster}{Phoenix, AZ}
...
I am applying for the position of Senior Engineer I - Site Reliability at Ticketmaster. I first learned of positions at Ticketmaster when I worked at SkySong. Recently,
I came across the following article https://thenewstack.io/how-ticketmaster-used-kubernetes-operators-to-fill-a-devops-gap/ which is what really drew
...
Site Reliability. Being able to solve problems creatively comes from facing problems with varying constraints which I excel at.
